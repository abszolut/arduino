// ARDUINO (cpu), ESP8266 (wifi), DHT11 (temp, humidity) logging to ThingsSpeak.com
// ================================================================================
// 2015-02    Tom Tobback, based this on seeedstudio's ESP8266 example
// 2015-04-16 Jonas S Karlsson rewritten and simplified
//
// Notes
// - update firmware to be able to set baud rate to 9600
// - new batch of ESP8266 from TAOBAO have baud rate set to 9600 and firmware 0.9.2.4
// - then can use software serial to handle ESP8266 at 9600 baud
// - include hardware reset before starting ESP
//
// ARDUINO pin connections
// =======================
// software serial on pin 10=UTXD and 11=URXD
// esp reset on pin 9=RST (pull low to reset)
// dht11 on pin 3

#include <SoftwareSerial.h>

#define SSID "Yesco"
#define PASS "fishfish"
...
boolean sendDataThingSpeak(float temp, float hum) {
   ...
   String path = "/update?key=00PDG1JQO2ZAYZL5&field1=";
   path += temp;
   path += "&field2=";
   path += hum;
   path += "\r\n";
